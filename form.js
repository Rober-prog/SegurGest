import { byId, uid, showSuccessMessage } from './utils.js';
...
let editingId = null;
let deps = { renderList: null, renderAccounting: null, go: null, showSuccessMessage: null };
...
function validate(obj){
  ...
  if(obj.type==='Vehículo'){ if(!obj.plate) missing.push('matrícula'); if(!obj.model) missing.push('marca y modelo'); }
  if(missing.length) throw 'Faltan datos: ' + missing.join(', ');
}
